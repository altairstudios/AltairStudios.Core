...
<asp:Content id="mainContent" ContentPlaceHolderID="mainContent" runat="server">
	<form action="<%=this.Url.Action("Admin", "Install")%>" class="form-horizontal">
		<fieldset>
			<legend><%=Translate.t("install_create_admin")%></legend>
			<div id="config-section-server" class="control-group">
				<label class="control-label" for="config-server"><%=Translate.t("user")%>:</label>
				<div class="controls">
					<input type="text" class="input-xlarge" name="user" id="config-user" placeholder="admin" />
				</div>
			</div>
			<div id="config-section-password" class="control-group">
